# -*- coding: utf-8 -*-
#
# dms_struct documentation build configuration file.
#
...
versionfile = os.path.abspath(os.path.join(
        os.path.dirname(__file__), '../dms_struct/__init__.py'))
...
htmlhelp_basename = 'dms_structdoc'
...
latex_documents = [
    (master_doc, 'dms_struct.tex', u'dms_struct Documentation',
